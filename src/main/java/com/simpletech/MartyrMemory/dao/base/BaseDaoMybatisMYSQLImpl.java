...
public class BaseDaoMybatisMYSQLImpl<T> implements MultiDao<T> {
	...
	public interface MybatisMultiDao<T>{
		...
		public List<T> findByNameAndPassword(String name, String  password) throws  Exception;
	}
	...
	@Override
	public List<T> findByNameAndPassword(String name, String  password)
		throws  Exception{

		return  multiDao.findByNameAndPassword(name, password);
	}
