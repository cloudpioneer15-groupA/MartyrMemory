...
public class VisitorController extends GeneralController<Visitor>{
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody Visitor model) throws Exception {
	...
	public Object update(@RequestBody Visitor model) throws Exception {
